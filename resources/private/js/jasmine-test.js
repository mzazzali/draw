...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t5395 && (cljs.core.t5395 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta5396 = g;
    ...
    }, cljs.core.t5395.cljs$lang$type = !0, cljs.core.t5395.cljs$lang$ctorStr = "cljs.core/t5395", cljs.core.t5395.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t5395")
    }, cljs.core.t5395.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t5395.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(c.slice()))
    }, cljs.core.t5395.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t5395.prototype.cljs$core$Fn$ = !0, cljs.core.t5395.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta5396
    }, cljs.core.t5395.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t5395(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t5395 = function(b, c, f, g) {
      return new cljs.core.t5395(b, c, f, g)
    });
    return new cljs.core.t5395(c, b, with_meta, null)
...
zee3.draw.defaults.base = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 100, new cljs.core.Keyword(null, "height", "height", 4087841945), 100, new cljs.core.Keyword(null, "lineWidth", "lineWidth", 3505084836), 1, new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264), "#FFFFFF", new cljs.core.Keyword(null, "Strokestyle", "Strokestyle", 
4632045003), "#FFFFFF"], !0);
zee3.draw.defaults.rounded_rectangle = cljs.core.merge.call(null, zee3.draw.defaults.base, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "cornerRadius", "cornerRadius", 1597500089), 5], !0));
zee3.draw.defaults.circle = cljs.core.merge.call(null, zee3.draw.defaults.base, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "centerX", "centerX", 1679143445), 0, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446), 100, new cljs.core.Keyword(null, "radius", "radius", 4370292740), 100, new cljs.core.Keyword(null, "lineWidth", "lineWidth", 3505084836), 1], !0));
zee3.draw.defaults.text = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264), "#FFFFFF", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "font", "font", 1017053121), "bold 16px Arial", new cljs.core.Keyword(null, "text", "text", 1017460895), ""], !0);
zee3.draw.shapes = {};
zee3.draw.shapes.entities = cljs.core.atom.call(null, cljs.core.PersistentVector.EMPTY);
zee3.draw.shapes.contexts = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
zee3.draw.shapes.entity_id = cljs.core.atom.call(null, 0);
zee3.draw.shapes.init_config = function(a, b, c) {
  return cljs.core.assoc.call(null, cljs.core.merge.call(null, zee3.draw.defaults.rounded_rectangle, c), new cljs.core.Keyword(null, "type", "type", 1017479852), a, new cljs.core.Keyword(null, "renderer", "renderer", 519058485), b)
};
zee3.draw.shapes.rectangle = function(a, b) {
  var c = zee3.draw.shapes.init_config.call(null, "rectangle", zee3.draw.shapes.draw_rectangle, b), d = cljs.core.get.call(null, cljs.core.deref.call(null, zee3.draw.shapes.contexts), a);
...
zee3.draw.shapes.rounded_rectangle = function(a, b) {
  var c = zee3.draw.shapes.init_config.call(null, "rounded-rectangle", zee3.draw.shapes.draw_rounded_rectangle, b), d = cljs.core.get.call(null, cljs.core.deref.call(null, zee3.draw.shapes.contexts), a);
  return zee3.draw.shapes.render.call(null, d, zee3.draw.shapes.base_config.call(null, a, c))
};
zee3.draw.shapes.circle = function(a, b) {
  var c = zee3.draw.shapes.init_config.call(null, "circle", zee3.draw.shapes.draw_circle, b), d = cljs.core.get.call(null, cljs.core.deref.call(null, zee3.draw.shapes.contexts), a);
  return zee3.draw.shapes.render.call(null, d, zee3.draw.shapes.base_config.call(null, a, c))
};
zee3.draw.shapes.text = function(a, b) {
  var c = zee3.draw.shapes.init_config.call(null, "text", zee3.draw.shapes.draw_text, b), d = cljs.core.get.call(null, cljs.core.deref.call(null, zee3.draw.shapes.contexts), a);
  return zee3.draw.shapes.render.call(null, d, zee3.draw.shapes.base_config.call(null, a, c))
};
zee3.draw.shapes.base_config = function(a, b) {
  var c = cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "stage", "stage", 1123661424), a);
...
zee3.draw.shapes.render = function(a, b) {
  for(var c = cljs.core.seq.call(null, cljs.core.vec.call(null, cljs.core.PersistentVector.fromArray([zee3.draw.shapes.render_shape, zee3.draw.colormap.render_shape], !0))), d = null, e = 0, f = 0;;) {
    if(f < e) {
      var g = cljs.core._nth.call(null, d, f);
      g.call(null, a, b);
      f += 1
      ...
      if(c = cljs.core.seq.call(null, c)) {
        d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), e = cljs.core.chunk_rest.call(null, d), d = c, g = cljs.core.count.call(null, c), c = e, e = g) : (g = cljs.core.first.call(null, d), g.call(null, a, b), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0
      }else {
        return null
      }
    }
...
zee3.draw.shapes.render_shape = function(a, b) {
  return(new cljs.core.Keyword(null, "renderer", "renderer", 519058485)).cljs$core$IFn$_invoke$arity$1(b).call(null, a, b)
};
zee3.draw.shapes.draw_base = function(a, b, c) {
  var d = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, e = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "strokeStyle", "strokeStyle", 2934623691)), f = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264)), d = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "lineWidth", "lineWidth", 3505084836));
  a.beginPath();
  a.fillStyle = f;
  a.strokeStyle = e;
  a.lineWidth = d;
  c.call(null, a, b);
  cljs.core.not_EQ_.call(null, "text", (new cljs.core.Keyword(null, "type", "type", 1017479852)).cljs$core$IFn$_invoke$arity$1(b)) && (a.fill(), a.stroke());
  a = cljs.core.seq.call(null, (new cljs.core.Keyword(null, "base-init", "base-init", 3445951998)).cljs$core$IFn$_invoke$arity$1(zee3.draw.defaults.cfg));
  c = null;
  for(d = f = 0;;) {
    if(d < f) {
      e = cljs.core._nth.call(null, c, d), e.call(null, b), d += 1
    }else {
      if(a = cljs.core.seq.call(null, a)) {
        c = a, cljs.core.chunked_seq_QMARK_.call(null, c) ? (a = cljs.core.chunk_first.call(null, c), f = cljs.core.chunk_rest.call(null, c), c = a, e = cljs.core.count.call(null, a), a = f, f = e) : (e = cljs.core.first.call(null, c), e.call(null, b), a = cljs.core.next.call(null, c), c = null, f = 0), d = 0
      }else {
        return null
      }
    }
...
zee3.draw.shapes.draw_rectangle = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "width", "width", 1127031096)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362));
...
zee3.draw.shapes.draw_rounded_rectangle = function(a, b) {
  ...
  cljs.core.get.call(null, c, new cljs.core.Keyword(null, "strokeStyle", "strokeStyle", 2934623691));
  cljs.core.get.call(null, c, new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264));
  cljs.core.get.call(null, c, new cljs.core.Keyword(null, "lineWidth", "lineWidth", 3505084836));
  var d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "width", "width", 1127031096)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362)), h = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "cornerRadius", "cornerRadius", 1597500089));
  return zee3.draw.shapes.draw_base.call(null, a, b, function() {
    a.moveTo(g + h, f);
    a.lineTo(g + e - h, f);
...
zee3.draw.shapes.draw_circle = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "radius", "radius", 4370292740)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "centerX", "centerX", 1679143445));
  return zee3.draw.shapes.draw_base.call(null, a, b, function() {
    return a.arc(f, e, d, 0, 2 * Math.PI, !1)
  })
};
zee3.draw.shapes.draw_text = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "font", "font", 1017053121)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "text", "text", 1017460895)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362));
  return zee3.draw.shapes.draw_base.call(null, a, b, function() {
    a.fillStyle = zee3.draw.shapes.fillStyle;
    a.font = d;
    a.textBaseline = zee3.draw.shapes.textBaseline;
    return a.fillText(e, g, f)
  })
};
zee3.draw.colormap = {};
zee3.draw.colormap.color_map = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
...
zee3.draw.colormap.get_by_id = function(a) {
  return cljs.core.first.call(null, cljs.core.filter.call(null, function(b) {
    return cljs.core._EQ_.call(null, a, cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597)))
  }, cljs.core.deref.call(null, zee3.draw.shapes.entities)))
};
zee3.draw.colormap.get_hit_context = function(a) {
  a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stage", "stage", 1123661424));
  a = zee3.draw.colormap.build_name.call(null, a);
  return(new cljs.core.Keyword(null, "context", "context", 1965435169)).cljs$core$IFn$_invoke$arity$1(zee3.draw.colormap.get_by_id.call(null, a))
};
zee3.draw.colormap.to_hex = function(a) {
  a = a.toString(16);
  return[cljs.core.str("00".substr(0, 2 - a.length)), cljs.core.str(a)].join("")
};
zee3.draw.colormap.from_hex = function(a) {
  var b = cljs.core.subs.call(null, a, 1, 3), c = cljs.core.subs.call(null, a, 3, 5);
  a = cljs.core.subs.call(null, a, 5, 7);
  return cljs.core.PersistentVector.fromArray([parseInt(b, 16), parseInt(c, 16), parseInt(a, 16)], !0)
};
zee3.draw.colormap.color_hash = function() {
  var a = cljs.core.atom.call(null, 1), b = cljs.core.atom.call(null, 0), c = cljs.core.atom.call(null, 0);
  return function() {
    ...
    255 < cljs.core.deref.call(null, a) && (cljs.core.swap_BANG_.call(null, b, cljs.core.inc), 0 < cljs.core.deref.call(null, b) ? cljs.core.reset_BANG_.call(null, a, 0) : cljs.core.reset_BANG_.call(null, a, 1));
...
zee3.draw.colormap.create_canvas = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "width", "width", 1127031096));
  cljs.core.get.call(null, c, new cljs.core.Keyword(null, "id", "id", 1013907597));
...
zee3.draw.colormap.draw_stage = function(a) {
  ...
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "height", "height", 4087841945));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "width", "width", 1127031096));
  var b = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597)), c = zee3.draw.colormap.build_name.call(null, b), d = zee3.draw.colormap.create_canvas.call(null, a, c), e = d.getContext("2d");
  return cljs.core.swap_BANG_.call(null, zee3.draw.shapes.entities, cljs.core.conj, cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "type", "type", 1017479852), "stage", new cljs.core.Keyword(null, "ref", "ref", 1014017029), d, new cljs.core.Keyword(null, "context", "context", 1965435169), e, new cljs.core.Keyword(null, "id", "id", 1013907597), c, new cljs.core.Keyword(null, "parent", "parent", 4313447452), b))
};
zee3.draw.colormap.render_text = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "textBaseline", "textBaseline", 3319858692)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "font", "font", 1017053121)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "text", "text", 1017460895)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), h = cljs.core.get.call(null, 
  c, new cljs.core.Keyword(null, "x", "x", 1013904362));
  return zee3.draw.shapes.draw_base.call(null, a, b, function() {
    a.fillStyle = "#050505";
    a.font = e;
    a.textBaseline = d;
    return a.fillText(f, h, g)
  })
};
zee3.draw.colormap.transpose_text = function(a, b, c) {
  for(var d = a.length / 4, e = 0;;) {
    if(e < d) {
      var f = 4 * e, g = a[f + 1], h = a[f + 2];
      cljs.core._EQ_.call(null, a[f], 5) && (cljs.core._EQ_.call(null, g, 5) && cljs.core._EQ_.call(null, h, 5)) && (b[f] = c.call(null, 0), b[f + 1] = c.call(null, 1), b[f + 2] = c.call(null, 2), b[f + 3] = 255, console.log([cljs.core.str("index:"), cljs.core.str(4 * e)].join("")));
      e += 1
    }else {
      break
    }
...
zee3.draw.colormap.draw_text = function(a, b) {
  var c = zee3.draw.colormap.get_by_id.call(null, a.canvas.id), c = zee3.draw.colormap.create_canvas.call(null, c, "tmp").getContext("2d");
  zee3.draw.colormap.render_text.call(null, c, b);
  var c = c.getImageData(0, 0, c.canvas.width, c.canvas.height).data, d = a.getImageData(0, 0, a.canvas.width, a.canvas.height), e = d.data, f = (new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264)).cljs$core$IFn$_invoke$arity$1(b), f = zee3.draw.colormap.from_hex.call(null, f);
  zee3.draw.colormap.transpose_text.call(null, c, e, f);
  return a.putImageData(d, 0, 0)
};
zee3.draw.colormap.render_shape = function(a, b) {
  var c = zee3.draw.colormap.color_generator.call(null), d = cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "strokeStyle", "strokeStyle", 2934623691), c, new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264), c), e = zee3.draw.colormap.get_hit_context.call(null, b);
  cljs.core.swap_BANG_.call(null, zee3.draw.colormap.color_map, cljs.core.assoc, c, b);
  return cljs.core._EQ_.call(null, "text", (new cljs.core.Keyword(null, "type", "type", 1017479852)).cljs$core$IFn$_invoke$arity$1(b)) ? zee3.draw.colormap.draw_text.call(null, e, d) : new cljs.core.Keyword(null, "else", "else", 1017020587) ? (new cljs.core.Keyword(null, "renderer", "renderer", 519058485)).cljs$core$IFn$_invoke$arity$1(b).call(null, e, d) : null
};
zee3.draw.colormap.absolute_point = function(a, b) {
  var c = cljs.core.first.call(null, cljs.core.filter.call(null, function(b) {
    return cljs.core._EQ_.call(null, a, cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597))) && cljs.core._EQ_.call(null, "stage", cljs.core.get.call(null, b, new cljs.core.Keyword(null, "type", "type", 1017479852)))
  }, cljs.core.deref.call(null, zee3.draw.shapes.entities))), c = cljs.core.seq_QMARK_.call(null, c) ? cljs.core.apply.call(null, cljs.core.hash_map, c) : c, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "ref", "ref", 1014017029)), e = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, c = cljs.core.get.call(null, e, new cljs.core.Keyword(null, "y", "y", 1013904363)), e = cljs.core.get.call(null, e, new cljs.core.Keyword(null, "x", "x", 1013904362)), 
  f = d.getBoundingClientRect(), g = document.documentElement, d = f.top - g.clientTop, f = f.left - g.clientLeft;
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "y", "y", 1013904363), c - Math.round(d), new cljs.core.Keyword(null, "x", "x", 1013904362), e - Math.round(f)], !0)
};
zee3.draw.colormap.handle_event = function(a, b) {
  var c = a.currentTarget.id, d = zee3.draw.colormap.absolute_point.call(null, c, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), a.clientX, new cljs.core.Keyword(null, "y", "y", 1013904363), a.clientY], !0)), e = cljs.core.seq_QMARK_.call(null, d) ? cljs.core.apply.call(null, cljs.core.hash_map, d) : d, d = cljs.core.get.call(null, e, new cljs.core.Keyword(null, "y", "y", 1013904363)), e = cljs.core.get.call(null, e, new cljs.core.Keyword(null, "x", "x", 
  1013904362)), c = zee3.draw.colormap.build_name.call(null, c), c = (new cljs.core.Keyword(null, "context", "context", 1965435169)).cljs$core$IFn$_invoke$arity$1(zee3.draw.colormap.get_by_id.call(null, c)), d = zee3.draw.colormap.pixel_color.call(null, c, e, d), d = cljs.core.get.call(null, cljs.core.deref.call(null, zee3.draw.colormap.color_map), d);
  return null != d ? (d = cljs.core.get.call(null, d, b), null != d ? d.call(null) : null) : null
};
zee3.draw.colormap.pixel_color = function(a, b, c) {
  a = a.getImageData(b, c, 1, 1).data;
  return[cljs.core.str("#"), cljs.core.str(zee3.draw.colormap.to_hex.call(null, a[0])), cljs.core.str(zee3.draw.colormap.to_hex.call(null, a[1])), cljs.core.str(zee3.draw.colormap.to_hex.call(null, a[2]))].join("")
};
zee3.draw.core = {};
zee3.draw.core.HIT_TEST_STAGE = "hit-test-stage";
zee3.draw.core.stage = function(a) {
  zee3.draw.core.draw_stage.call(null, a);
  return zee3.draw.colormap.draw_stage.call(null, a)
};
zee3.draw.core.draw_stage = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "height", "height", 4087841945)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "width", "width", 1127031096)), b = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597)), e = document.createElement("canvas");
  e.id = b;
  e.width = d;
  e.height = c;
  ...
  c = e.getContext("2d");
  cljs.core.swap_BANG_.call(null, zee3.draw.shapes.contexts, cljs.core.assoc, b, c);
  return cljs.core.swap_BANG_.call(null, zee3.draw.shapes.entities, cljs.core.conj, cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "type", "type", 1017479852), "stage", new cljs.core.Keyword(null, "ref", "ref", 1014017029), e, new cljs.core.Keyword(null, "context", "context", 1965435169), c))
};
...
zee3.draw.core.handle_mouseup = function(a) {
  return zee3.draw.core.handle_event.call(null, a, new cljs.core.Keyword(null, "mouseup", "mouseup", 2256972146))
};
zee3.draw.core.handle_mousemove = function(a) {
  return zee3.draw.core.handle_event.call(null, a, new cljs.core.Keyword(null, "mousemove", "mousemove", 1601016168))
};
zee3.draw.core.handle_mousedown = function(a) {
  return zee3.draw.core.handle_event.call(null, a, new cljs.core.Keyword(null, "mousedown", "mousedown", 1600748089))
};
zee3.draw.core.handle_event = function(a, b) {
  return zee3.draw.colormap.handle_event.call(null, a, b)
};
zee3.draw.core.intersects = function(a, b) {
  return zee3.draw.colormap.intersects.call(null, a, zee3.draw.core.absolute_point.call(null, (new cljs.core.Keyword(null, "stage", "stage", 1123661424)).cljs$core$IFn$_invoke$arity$1(a), b))
};
...
zee3.draw.core.entity_id = function entity_id(b) {
  return cljs.core.contains_QMARK_.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597), b) ? cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597)) : cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597), cljs.core.swap_BANG_.call(null, entity_id, cljs.core.inc))
};
zee3.draw.core.get_entity = function(a) {
  return cljs.core.first.call(null, cljs.core.filter.call(null, function(b) {
    return cljs.core._EQ_.call(null, a, cljs.core.get.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597)))
  }, cljs.core.deref.call(null, zee3.draw.shapes.entities)))
};
...
describe("create stage", function() {
  beforeEach(function() {
    return zee3.draw.core.stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "test-stage", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0))
  });
  afterEach(function() {
...
describe("create rectangle", function() {
  beforeEach(function() {
    zee3.draw.core.stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "test-stage2", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0));
    return zee3.draw.shapes.rectangle.call(null, "test-stage2", cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "my-rectangle", new cljs.core.Keyword(null, "x", "x", 1013904362), 10, new cljs.core.Keyword(null, "y", "y", 1013904363), 10, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0))
  });
  afterEach(function() {
...
describe("create rounded-rectangle", function() {
  beforeEach(function() {
    zee3.draw.core.stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "test-stage", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0));
    return zee3.draw.shapes.rounded_rectangle.call(null, "test-stage", cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "my-rounded-rectangle", new cljs.core.Keyword(null, "x", "x", 1013904362), 10, new cljs.core.Keyword(null, "y", "y", 1013904363), 10, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0))
  });
  afterEach(function() {
    return document.getElementsByTagName("body")[0].removeChild(document.getElementById("test-stage"))
  });
...
describe("create circle", function() {
  beforeEach(function() {
    zee3.draw.core.stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "test-stage1", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0));
    return zee3.draw.shapes.circle.call(null, "test-stage1", cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "my-circle", new cljs.core.Keyword(null, "centerX", "centerX", 1679143445), 100, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446), 100, new cljs.core.Keyword(null, "radius", "radius", 4370292740), 10], !0))
  });
  afterEach(function() {
...
describe("create text", function() {
  beforeEach(function() {
    zee3.draw.core.stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "test-stage1", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0));
    return zee3.draw.shapes.text.call(null, "test-stage1", cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), "my-text", new cljs.core.Keyword(null, "fillStyle", "fillStyle", 4181927264), "#FFFFFF", new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "font", "font", 1017053121), "bold 16px Arial", new cljs.core.Keyword(null, "text", "text", 1017460895), ""], !0))
  });
  afterEach(function() {
    return document.getElementsByTagName("body")[0].removeChild(document.getElementById("test-stage1"))
  });
  return it("test that the text was created", function() {
    return expect(cljs.core.not_EQ_.call(null, null, zee3.draw.core.get_entity.call(null, "my-text"))).toBeTruthy()
  })
});
zee3.draw.colormap_test = {};
zee3.draw.colormap_test.STAGE_NAME = "test-stage2";
describe("test build-name", function() {
  return it("test that the build name prepends the hit-test prefix", function() {
    return expect(cljs.core._EQ_.call(null, [cljs.core.str("test"), cljs.core.str(zee3.draw.defaults.HIT_TEST_STAGE)].join(""), zee3.draw.colormap.build_name.call(null, "test"))).toBeTruthy()
  })
});
describe("test get-by-id", function() {
  zee3.draw.colormap.draw_stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), zee3.draw.colormap_test.STAGE_NAME, new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0));
  return it("test that we can retrieve an entity by id", function() {
    return expect(null != zee3.draw.colormap.get_by_id.call(null, zee3.draw.colormap_test.STAGE_NAME)).toBeTruthy()
  })
});
describe("test to-hex", function() {
  it("test convert 1 to hex", function() {
    return expect(cljs.core._EQ_.call(null, "01", zee3.draw.colormap.to_hex.call(null, 1))).toBeTruthy()
  });
  it("test convert 10 to hex", function() {
    return expect(cljs.core._EQ_.call(null, "0a", zee3.draw.colormap.to_hex.call(null, 10))).toBeTruthy()
  });
  return it("test convert 28 to hex", function() {
    return expect(cljs.core._EQ_.call(null, "1c", zee3.draw.colormap.to_hex.call(null, 28))).toBeTruthy()
  })
});
describe("test from-hex", function() {
  it("convert #FFFFFF to decimal", function() {
    return expect(cljs.core._EQ_.call(null, cljs.core.PersistentVector.fromArray([255, 255, 255], !0), zee3.draw.colormap.from_hex.call(null, "#FFFFFF"))).toBeTruthy()
  });
  it("convert #000000 to decimal", function() {
    return expect(cljs.core._EQ_.call(null, cljs.core.PersistentVector.fromArray([0, 0, 0], !0), zee3.draw.colormap.from_hex.call(null, "#000000"))).toBeTruthy()
  });
  return it("convert #090909 to decimal", function() {
    return expect(cljs.core._EQ_.call(null, cljs.core.PersistentVector.fromArray([9, 9, 9], !0), zee3.draw.colormap.from_hex.call(null, "#090909"))).toBeTruthy()
  })
});
describe("test color-generator", function() {
  it("retrieve unique color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#050000", zee3.draw.colormap.color_generator.call(null))).toBeTruthy()
  });
  it("retrieve next unique color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#060000", zee3.draw.colormap.color_generator.call(null))).toBeTruthy()
  });
  it("retrieve first green color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#000100", cljs.core.last.call(null, cljs.core.repeatedly.call(null, 250, function() {
      return zee3.draw.colormap.color_generator.call(null)
    })))).toBeTruthy()
  });
  return it("retrieve first blue color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#000001", cljs.core.last.call(null, cljs.core.repeatedly.call(null, 65280, function() {
      return zee3.draw.colormap.color_generator.call(null)
    })))).toBeTruthy()
  })
});
describe("test draw-stage", function() {
  var a = zee3.draw.colormap.draw_stage.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "id", "id", 1013907597), zee3.draw.colormap_test.STAGE_NAME, new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "width", "width", 1127031096), 300, new cljs.core.Keyword(null, "height", "height", 4087841945), 300], !0)), b = cljs.core.first.call(null, cljs.core.filter.call(null, function(a) {
    return function(a) {
      return cljs.core._EQ_.call(null, zee3.draw.colormap.build_name.call(null, zee3.draw.colormap_test.STAGE_NAME), cljs.core.get.call(null, a, new cljs.core.Keyword(null, "id", "id", 1013907597)))
    }
  }(a), cljs.core.deref.call(null, zee3.draw.shapes.entities)));
  it("draw the stage", function() {
    return expect(null != b).toBeTruthy()
  });
  it("Check the stages type", function() {
    return expect(cljs.core._EQ_.call(null, "stage", cljs.core.get.call(null, b, new cljs.core.Keyword(null, "type", "type", 1017479852)))).toBeTruthy()
  });
  return it("Check it has a reference to the dom element", function() {
    return expect(null != cljs.core.get.call(null, b, new cljs.core.Keyword(null, "ref", "ref", 1014017029))).toBeTruthy()
  })
});
describe("test transpose-text", function() {
  return it("test that the transpose function transposes", function() {
    return expect(cljs.core._EQ_.call(null, cljs.core.vector.call(null, 100, 100, 100, 255), cljs.core.js__GT_clj.call(null, zee3.draw.colormap.transpose_text.call(null, [5, 5, 5, 5], [3, 4, 5, 6], cljs.core.PersistentVector.fromArray([100, 100, 100], !0))))).toBeTruthy()
  })
});
zee3.draw.algohitdetection = {};
zee3.draw.algohitdetection.intersects_circle = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "radius", "radius", 4370292740)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "centerX", "centerX", 1679143445)), g = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, c = cljs.core.get.call(null, 
  g, new cljs.core.Keyword(null, "y", "y", 1013904363)), f = cljs.core.get.call(null, g, new cljs.core.Keyword(null, "x", "x", 1013904362)) - f, e = c - e;
  return f * f + e * e < d * d
};
zee3.draw.algohitdetection.intersects_rectangle = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "width", "width", 1127031096)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362)), g = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, 
  cljs.core.hash_map, b) : b, h = cljs.core.get.call(null, g, new cljs.core.Keyword(null, "x", "x", 1013904362)), g = cljs.core.get.call(null, g, new cljs.core.Keyword(null, "y", "y", 1013904363));
  return h > c && h < c + e && g > f && g < f + d
};
zee3.draw.algohitdetection.intersects_rounded_rectangle = function(a, b) {
  return cljs.core.truth_(zee3.draw.algohitdetection.intersects_rectangle.call(null, a, b)) ? (!0).call(null) : (!1).call(null)
};
zee3.draw.algohitdetection_test = {};
describe("test rectangle intersection", function() {
  it("should intersect", function() {
    return expect(cljs.core._EQ_.call(null, !0, zee3.draw.algohitdetection.intersects_rectangle.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 10, new cljs.core.Keyword(null, "y", "y", 1013904363), 10, new cljs.core.Keyword(null, "width", "width", 1127031096), 100, new cljs.core.Keyword(null, "height", "height", 4087841945), 100], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 90, new cljs.core.Keyword(null, 
    "y", "y", 1013904363), 90], !0)))).toBeTruthy()
  });
  return it("should not intersect", function() {
    return expect(cljs.core._EQ_.call(null, !1, zee3.draw.algohitdetection.intersects_rectangle.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 10, new cljs.core.Keyword(null, "y", "y", 1013904363), 10, new cljs.core.Keyword(null, "width", "width", 1127031096), 100, new cljs.core.Keyword(null, "height", "height", 4087841945), 100], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 120, new cljs.core.Keyword(null, 
    "y", "y", 1013904363), 120], !0)))).toBeTruthy()
  })
});
describe("test circle intersection", function() {
  it("should intersect", function() {
    return expect(cljs.core._EQ_.call(null, !0, zee3.draw.algohitdetection.intersects_circle.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "centerX", "centerX", 1679143445), 30, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446), 30, new cljs.core.Keyword(null, "radius", "radius", 4370292740), 20], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 30, new cljs.core.Keyword(null, "y", "y", 1013904363), 30], !0)))).toBeTruthy()
  });
  return it("should not intersect", function() {
    return expect(cljs.core._EQ_.call(null, !1, zee3.draw.algohitdetection.intersects_circle.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "centerX", "centerX", 1679143445), 30, new cljs.core.Keyword(null, "centerY", "centerY", 1679143446), 30, new cljs.core.Keyword(null, "radius", "radius", 4370292740), 20], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "x", "x", 1013904362), 120, new cljs.core.Keyword(null, "y", "y", 1013904363), 120], 
    !0)))).toBeTruthy()
  })
});
zee3.draw.global = {};
zee3.draw.global.entities = cljs.core.atom.call(null, cljs.core.PersistentVector.EMPTY);
zee3.draw.global.contexts = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
