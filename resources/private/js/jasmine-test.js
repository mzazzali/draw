...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3051) {
      cljs.core.t3051 = {};
      cljs.core.t3051 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3052 = c;
      ...
      cljs.core.t3051.cljs$lang$type = !0;
      cljs.core.t3051.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3051")
      };
      cljs.core.t3051.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3051")
      };
      var c = cljs.core.t3051.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t3051.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t3051.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3051.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3052
      };
      cljs.core.t3051.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t3051(this.meta, this.f, b)
      }
    }
    return new cljs.core.t3051(b, a, null)
  }(), b)
};
...
zee3.draw.shapes.init_config = function(a, b, c) {
  return cljs.core.assoc.call(null, cljs.core.merge.call(null, zee3.draw.defaults.rounded_rectangle, c), "\ufdd0'type", a, "\ufdd0'renderer", b)
};
...
zee3.draw.shapes.render = function(a, b) {
  for(var c = cljs.core.seq.call(null, cljs.core.vec.call(null, cljs.core.PersistentVector.fromArray([zee3.draw.shapes.render_shape, zee3.draw.colormap.render_shape], !0)));;) {
    if(c) {
      cljs.core.first.call(null, c).call(null, a, b), c = cljs.core.next.call(null, c)
    }else {
      return null
    }
  }
...
zee3.draw.shapes.render_shape = function(a, b) {
  return(new cljs.core.Keyword("\ufdd0'renderer")).call(null, b).call(null, a, b)
};
zee3.draw.shapes.draw_base = function(a, b, c) {
  ...
  a.fill();
  a.stroke();
  for(a = cljs.core.seq.call(null, (new cljs.core.Keyword("\ufdd0'base-init")).call(null, zee3.draw.defaults.cfg));;) {
    if(a) {
      cljs.core.first.call(null, a).call(null, b), a = cljs.core.next.call(null, a)
    }else {
      return null
    }
  }
...
zee3.draw.shapes.draw_text = function(a, b) {
  var c = zee3.draw.shapes.mc, c = cljs.core.seq_QMARK_.call(null, c) ? cljs.core.apply.call(null, cljs.core.hash_map, c) : c;
  cljs.core._lookup.call(null, c, "\ufdd0'radius", null);
  ...
  return zee3.draw.shapes.draw_base.call(null, d, b, function() {
    ...
    return d.fillText(zee3.draw.shapes.text)
  })
};
zee3.draw.colormap = {};
...
zee3.draw.core.draw_stage = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core._lookup.call(null, b, "\ufdd0'height", null), d = cljs.core._lookup.call(null, b, "\ufdd0'width", null), b = cljs.core._lookup.call(null, b, "\ufdd0'id", null), e = document.createElement("canvas");
  e.id = b;
  e.width = d;
  e.height = c;
  ...
  return cljs.core.swap_BANG_.call(null, zee3.draw.shapes.entities, cljs.core.conj, cljs.core.assoc.call(null, a, "\ufdd0'type", "stage", "\ufdd0'ref", e, "\ufdd0'context", c))
};
...
zee3.draw.core.intersects_rectangle = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core._lookup.call(null, c, "\ufdd0'height", null), e = cljs.core._lookup.call(null, c, "\ufdd0'width", null), f = cljs.core._lookup.call(null, c, "\ufdd0'y", null), g = cljs.core._lookup.call(null, c, "\ufdd0'x", null), c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, h = cljs.core._lookup.call(null, c, "\ufdd0'x", null), c = cljs.core._lookup.call(null, 
  c, "\ufdd0'y", null), i = h > g;
  return i ? (e = h < g + e) ? (e = c > f) ? c < f + d : e : e : i
};
...
describe("test get-by-id", function() {
  zee3.draw.colormap.draw_stage.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'x", "\ufdd0'y", "\ufdd0'width", "\ufdd0'height"], {"\ufdd0'id":zee3.draw.colormap_test.STAGE_NAME, "\ufdd0'x":0, "\ufdd0'y":0, "\ufdd0'width":300, "\ufdd0'height":300}));
...
describe("test", function() {
  return it("retrieve first green color hash", function() {
    return expect(cljs.core._EQ_.call(null, 2, cljs.core.last.call(null, cljs.core.repeatedly.call(null, 255, function() {
      return 2
    })))).toBeTruthy()
  })
});
...
describe("test color-generator", function() {
  it("retrieve unique color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#030000", zee3.draw.colormap.color_generator.call(null))).toBeTruthy()
  });
  it("retrieve next unique color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#040000", zee3.draw.colormap.color_generator.call(null))).toBeTruthy()
  });
  it("retrieve first green color hash", function() {
    return expect(cljs.core._EQ_.call(null, "#000100", cljs.core.last.call(null, cljs.core.repeatedly.call(null, 252, function() {
...
describe("test draw-stage", function() {
  zee3.draw.colormap.draw_stage.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'x", "\ufdd0'y", "\ufdd0'width", "\ufdd0'height"], {"\ufdd0'id":zee3.draw.colormap_test.STAGE_NAME, "\ufdd0'x":0, "\ufdd0'y":0, "\ufdd0'width":300, "\ufdd0'height":300}));
  var a = cljs.core.first.call(null, cljs.core.filter.call(null, function(a) {
    return cljs.core._EQ_.call(null, zee3.draw.colormap.build_name.call(null, zee3.draw.colormap_test.STAGE_NAME), cljs.core._lookup.call(null, a, "\ufdd0'id", null))
  }, cljs.core.deref.call(null, zee3.draw.shapes.entities)));
  it("draw the stage", function() {
    return expect(null != a).toBeTruthy()
  });
  it("Check the stages type", function() {
    return expect(cljs.core._EQ_.call(null, "stage", cljs.core._lookup.call(null, a, "\ufdd0'type", null))).toBeTruthy()
  });
  return it("Check it has a reference to the dom element", function() {
    return expect(null != cljs.core._lookup.call(null, a, "\ufdd0'ref", null)).toBeTruthy()
  })
});
zee3.draw.global = {};
